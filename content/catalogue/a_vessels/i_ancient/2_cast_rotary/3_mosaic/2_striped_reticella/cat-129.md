...
For the production technique see comments on {% cat '85.AF.85' %}. On the trade of small fragments of mosaic glass in nineteenth-century Rome and on the different techniques and classes of mosaic glass present in the JPGM collection, see comments on {% cat '76.AF.70.21' %}. This bowl belongs to Roman cast Composite Mosaic vessels and in particular to the Non-Carinated Bowls group ([[Grose 1989]], pp. 258–261), which are one of the most numerous groups of mosaic vessels, with deep and shallow bowls being among the most widely appearing forms; others are plates and beakers. The checkerboard pattern is quite rare, and the other published examples are broad shallow bowls with single interior grooves and the pattern is created by tesserae in two or three colors ([[Grose 1989]], p. 260, nos. 564–567). There are known carinated mosaic bowls with checkerboard patterns that date this group in the late first century BCE–early first century CE ([[Abdul-Hak 1959]], p. 81, fig. 14; [[Goldstein 1979]], pp. 186–187, no. 497).
