...
These pendants are usually made in a single color and occasionally are embellished with details like the fins and the rostrum in another color. Several examples are known from burials of the Roman imperial to early Byzantine (fourth–seventh centuries) period at Syro-Palestinian sites ({% cite 'Spaer 2001' %}, p. 186, fig. 83, p. 188 no. 427, plate 32; {% cite 'Chebab 1986' %}, p. 167, plate 27:1, 3–5), on Cyprus ({% cite 'Lightfoot 2017' %}, p. 314, nos. 478–479) as well as Germany ({% cite 'Pirling 1979' %}: tomb 2826), Hungary ({% cite 'Burger 1966' %}, p. 104, fig. 97, tomb 47:10, with a ca. fourth-century glass jug), and the Black Sea coast ({% cite 'Alekseeva 1978' %}, single-colored glass, pp. 73–74, form 184, plate 34, no. 21, ascribed to the first century CE).
