...
Core–formed vessels appear for the first time in the Aegean Sea region in the sixth century BCE, quite probably having been produced on the island of Rhodes. These are genuinely innovative products that do not imitate or evolve from known shapes in the repertoire of Mesopotamian and Egyptian core-formed vessels, but rather render the shapes of contemporaneous Greek clay vessels, in particular alabastra ({% cat '2003.180' 'cats. 10' %}–{% cat '2003.186' '21' %}), amphoriskoi (small amphoras) ({% cat '2003.178' 'cats. 34' %}–{% cat '2003.175' '41' %}), aryballoi ({% cat '2003.174' 'cats. 53' %}–{% cat '2003.176' '56' %}), and oinochoai/juglets ({% cat '2003.179' 'cats. 48' %}–{% cat '2003.166' '49' %}). It is believed that they were used as unguentaria, intended for aromatic and cosmetic substances.
...
Free-blown vessels represent the largest group of the JPGM vessels, with 148 examples, among them 4 plates and dishes ({% cat '2003.387' 'cats. 229' %}–{% cat '2003.351' '232' %}), 23 bowls and cups ({% cat '2003.290' 'cats. 233' %}–{% cat '2003.455' '255'%}), 10 beakers ({% cat '96.AF.320' 'cats. 256' %}–{% cat '2003.444' '265' %}), 1 skyphos ({% cat '2003.361' %}), 1 kantharos ({% cat '84.AF.30' %}), 2 amphorae ({% cat '2003.402' 'cats. 268' %}–{% cat '78.AF.18' '269' %}), 14 flasks ({% cat '96.AF.56' 'cats. 270' %}–{% cat '2003.449' '283' %}), 5 guti ({% cat '2003.245' 'cats. 284' %}–{% cat '2003.447' '288' %}), 18 jugs ({% cat '2003.476' 'cats. 289' %}–{% cat '2003.288' '306' %}), 1 bottle ({% cat '71.AF.79' %}), and 28 unguentaria ({% cat '2003.297' 'cats. 190' %}–{% cat '2003.306' '217' %}) (12 handleless, 3 sprinklers, 11 amphoriskoi, 2 oinochoae).
...
Mold-blown vessels represent a large group among the JPGM vessels, with 59 examples. Among them are 10 bowls and cups ({% cat '2003.474' 'cats. 159' %}–{% cat '2004.34' '168' %}), 6 beakers ({% cat '85.AF.83' 'cats. 169' %}–{% cat '2003.323' '174' %}), 6 flasks ({% cat '2004.36' 'cats. 175' %}–{% cat '2003.343' '180' %}), 9 jugs ({% cat '85.AF.320' 'cats. 181' %}–{% cat '2003.344' '189' %}), and 28 unguentaria ({% cat '2003.297' 'cats. 190' %}–{% cat '2003.306' '217' %}: 12 handleless, 3 sprinklers, 11 amphoriskoi, 2 oinochoae).
