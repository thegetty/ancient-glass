...
This decorative technique appears in the eastern Mediterranean at the end of the second century,[^81] becomes more widespread from the fifth century on, and remains in use until the eighth century, at least in Jordan and in the Syro-Palestinian area ({% cat '2003.477' %}, {% cat '2003.437' %}, {% cat '2004.42' %}).[^82] Pinching was also used for the shaping of scalloped rims, such as in the case of a bowl in the JPGM collection ({% cat '78.AF.22' %}).
